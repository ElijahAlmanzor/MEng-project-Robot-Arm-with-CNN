...
def depth_image(data):
	...
	if flag1==1:
	      ...
	      imaged=('/home/narly/zed_ur_ws_yf/src/ur_rg2/ur_control/scripts/test_dataset/image_depth%d.png' % num)
...
def image(frame1):
    ...
    if flag2==1:
        ...
        image=('/home/narly/zed_ur_ws_yf/src/ur_rg2/ur_control/scripts/test_dataset/image%d.png' % xx)
